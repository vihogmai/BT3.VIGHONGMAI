...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/907f6aa2-7e86-4f6f-9f03-315a05fb719f" />
...
Số Tiền Thu: Ghi nhận 40,000.00đ (tiền lãi khách vừa đóng).
...
2. Sự kiện Gia hạn (Tránh lãi kép)
(Dựa trên bảng kết quả phía dưới trong ảnh image_27f378.png)

Logic xử lý: Khi khách đóng lãi thành công, hệ thống thực hiện đồng thời 2 việc:

Ngày Reset Lãi: Cập nhật về ngày hiện tại (2026-05-09). Việc này cực kỳ quan trọng vì nó đưa số ngày vay về 0, khiến lãi suất kỳ sau chỉ tính trên tiền Gốc ban đầu.

Dời Deadline: Bạn có thể thấy Hạn Mới D1 và Hạn Mới D2 đã được đẩy sang tháng 8 và tháng 9 năm 2026.

Lợi ích cho khách hàng: Khách không bị "lãi mẹ đẻ lãi con" (lãi chồng lên phần lãi cũ chưa trả).

 Tránh việc ghi đè số tổng nợ
 Theo dõi lịch sử dòng tiền

TÓM LAI: Hệ thống hiện tại vận hành theo một vòng đời khép kín:

Trigger 1: Tự động bắt nợ xấu khi quá Deadline 1.

Trigger 2: Tự động chuyển đồ sang "Sẵn sàng thanh lý" khi quá Deadline 2.

Procedure Gia hạn: Cho phép cứu vãn hợp đồng, đưa trạng thái từ "Quá hạn" quay về "Đang vay".

Audit Log: Lặng lẽ ghi lại mọi biến động tiền tệ để báo cáo tài chính.
